...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    ...
    <div class="side">
        ...
        <form class="ticketInsert" method="post">
            <label for="AAAAA" class="form-label" style="margin: 1rem 1rem 0.5rem 1rem;">예매 정보</label>
            <table class="table table-light table-sm" id="ticket_info">
		
		          <tr>
		            <th class="center table-secondary" scope="row" style="width: 7rem; vertical-align : middle;">공연명</th>
		            <td>
		                ${PlayVO.play_name}
		          ...
		          <tr>
		            <th class="center table-secondary" scope="row" style="width: 7rem; vertical-align : middle;">공연 일정</th>
		            <td id="myticketDate">
		          ...
		          <tr>
		            <th class="center table-secondary" scope="row" style="width: 7rem; vertical-align : middle;">선택 좌석</th>
		            <td>
		          ...
		          <tr>
		            <th class="center table-secondary" scope="row" style="width: 7rem; vertical-align : middle;">티켓 금액</th>
		            <td>
		              <c:choose>
		          ...
		          <tr>
		            <th class="center table-secondary" scope="row" style="width: 7rem; vertical-align : middle;">할인 내역</th>
		            <td>
		          ...
		          <tr>
		            <th class="center table-secondary" scope="row" style="width: 7rem; vertical-align : middle;">총 결제 금액</th>
		            <td>
